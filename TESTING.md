...
| Endpoint | Method | CRUD Operation | Description | Images | Expected Result | Actual Result | Pass/Fail |
|----------|--------|----------------|-------------|--------|-----------------|---------------|-----------|
| `/reviews/` | GET | Read | List all reviews | <details><summary>Click to view Reviews List</summary>![Reviews](doc/images/reviews/reviews-get-all.png)</details> | Returns a list of all reviews | Returned a list of all reviews successfully | ✅ |
| `/reviews/` | POST | Create | Create a new review (authenticated users only) | <details><summary>Click to view Create Review Test - Missing Fields</summary>![Reviews]()</details> <details><summary>Click to view Create Review step 1</summary>![Reviews]()</details> <details><summary>Click to view Create Review step 2</summary>![Reviews]()</details>| New review is created and returned | New review created and returned successfully | ✅ |
...
| `/reviews/{id}/` | DELETE | Delete | Delete a specific review (owner only) | <details><summary>Click to view Delete Review step 1</summary>![Reviews]()</details> <details><summary>Click to view Delete Review step 2 </summary>![Reviews]()</details> <details><summary>Click to view Delete Review step 3 - Success</summary>![Reviews]()</details>| Deletes the specified review for the authenticated owner | Review deleted successfully for the authenticated owner | ✅ |
