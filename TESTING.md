...
| Endpoint | Method | CRUD Operation | Description | Images | Expected Result | Actual Result | Pass/Fail |
|----------|--------|----------------|-------------|--------|-----------------|---------------|-----------|
| `/contactus/` | POST | Create | Create a new contact message | <details><summary>Click to view Create Contact Message step 1</summary>![Contact Us](doc/images/contactus/contactus.png)</details> <details><summary>Click to view Create Contact Message step 2</summary>![Contact Us](doc/images/contactus/contactus-post.png)</details> | New contact message is created and returned | New contact message created and returned successfully | ✅ |
